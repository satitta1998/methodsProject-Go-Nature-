...
public class TravellerPageController {
    ...
    /**
     * Handles the action event when the exit button is pressed.
     * This method prints a message indicating the exit from the home page and then exits the application.
     *
     * @param event The action event triggered by pressing the exit button.
     * @throws Exception if an exception occurs during the exit process.
     */
