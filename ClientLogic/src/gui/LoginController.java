 ...
 * This class handles user authentication and navigation based on login credentials.
 */
package gui;
...
public class LoginController {
     ...
     * It handles the user authentication process and navigates to appropriate pages based on the user type.
     *
     * @param event The ActionEvent generated by clicking the "Login" button.
     * @throws Exception If an error occurs during the login process or navigation.
     */
    @FXML
